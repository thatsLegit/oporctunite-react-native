...
import { VictoryChart, VictoryGroup, VictoryAxis, VictoryBar, VictoryContainer } from "victory-native";
...
const BarChart2 = props => {
    ...
    const majSousCategories = useCallback(async () => {       
        const result = await fetchMoyenneSousCategorieBilan("Environnement approprié");
