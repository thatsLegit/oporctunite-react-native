...
const BarChart3 = props => {
    ...
    useSelector(state => Object.entries(state.bilan.noteGlobaleSousCateg)).map(([key, value]) => {
        ...
        if (Object.values(value) == "Expression des comportements") {
            ...
            >
                ...
                >
                    <VictoryBar
                        ...
                        data={[{ x: lineBreaker(titreGlobaleSousCateg[0], 15), y: tableauNoteSousCategArranger[0] }, { x: lineBreak(titreGlobaleSousCateg[1], 15), y: tableauNoteSousCategArranger[1] }, { x: lineBreaker(titreGlobaleSousCateg[2], 15), y: tableauNoteSousCategArranger[2] }]}
                    />
                    <VictoryBar
                        style={{ data: { fill: "#FF6666" } }}
                        data={[{ x: lineBreaker(titreGlobaleSousCateg[0], 15), y: moyenneGlobaleSousCateg[0] }, { x: lineBreak(titreGlobaleSousCateg[1], 15), y: moyenneGlobaleSousCateg[1] }, { x: lineBreaker(titreGlobaleSousCateg[2], 15), y: moyenneGlobaleSousCateg[2] }]}
                    />
