            ...
            <VictoryChart
                ...
                <VictoryGroup offset={18}>
                    <VictoryBar
                        ...
                        data={[{ x: lineBreaker(titreGlobaleSousCateg[0], 15), y: tableauNoteSousCategArranger[0] }, { x: lineBreaker(titreGlobaleSousCateg[1], 15), y: tableauNoteSousCategArranger[1] }, { x: lineBreaker(titreGlobaleSousCateg[2], 15), y: tableauNoteSousCategArranger[2] }]}
                    />
                    <VictoryBar
                        style={{ data: { fill: "#FF6666" } }}
                        data={[{ x: lineBreaker(titreGlobaleSousCateg[0], 15), y: moyenneGlobaleSousCateg[0] }, { x: lineBreaker(titreGlobaleSousCateg[1], 15), y: moyenneGlobaleSousCateg[1] }, { x: lineBreaker(titreGlobaleSousCateg[2], 15), y: moyenneGlobaleSousCateg[2] }]}
                    />
