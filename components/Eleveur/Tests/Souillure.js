                    ...
                    <View>
                        <View>
                            <Text style={styles.text}>
                                ...
                                La truie est propre ou présence de très légères traces de souillures qui concernent moins d'un tiers d'une des 5 zones de la truie {" "}
                            </Text>
                        </View>
